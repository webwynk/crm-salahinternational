            ...
            >
                ...
                <div className="h-16 flex items-center justify-between px-4 border-b border-neutral-800 shrink-0">
                    <Link href="/dashboard" className="flex items-center gap-3 overflow-hidden min-w-0" onClick={onCloseMobile}>
                        {/* Amber leather-stitch icon */}
                        <div className="w-9 h-9 rounded-md bg-brand-500 flex items-center justify-center text-white shrink-0 shadow-sm">
                        ...
                        {!isCollapsed && (
                            <div className="truncate min-w-0">
                                ...
                                <span className="text-[10px] text-neutral-500 block tracking-widest uppercase">
                                    Manufacturing CRM
                                </span>
                            </div>
                        )}
                ...
                <nav className="flex-1 px-2 py-3 space-y-0.5 overflow-y-auto scrollbar-thin">
                    {navItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                <Icon
                                    className={`w-4.5 h-4.5 shrink-0 ${item.active ? 'text-brand-400' : 'text-neutral-500 group-hover:text-white'}`}
                                    strokeWidth={1.75}
                                    size={18}
                                />
                                {!isCollapsed && (
                ...
                <div className="px-2 pb-3 pt-2 border-t border-neutral-800 space-y-1 shrink-0">
                    ...
                    >
                        {/* Avatar circle */}
                        <div className="w-[18px] h-[18px] rounded-full bg-brand-600 text-white font-bold text-[9px] flex items-center justify-center shrink-0">
                    ...
                    <Link
                        ...
                        as="button"
                        title="Sign out"
                        className="flex items-center gap-3 px-3 py-2 rounded-md w-full text-neutral-500 hover:bg-neutral-800 hover:text-danger-400 transition-colors text-sm"
                    >
                    ...
                    <button
                        ...
                        className="hidden lg:flex w-full items-center justify-center py-1.5 text-neutral-600 hover:text-white hover:bg-neutral-800 rounded-md transition-colors"
