    ...
    const kpiCards = [
        {
            ...
            unit: 'Models',
            subtext: 'BOM Recipes Configured',
            icon: Package,
        ...
        },
        {
            ...
            unit: 'Materials',
            subtext: `${stats.total_variants || stats.total_materials} active SKUs tracked`,
            icon: Layers,
        ...
        },
        {
            ...
            unit: 'Workers',
            subtext: 'Workshop Production Team',
            icon: Users,
        ...
        },
        {
            ...
            unit: 'Work Orders',
            subtext: `${stats.total_units_in_production || 0} batch units on bench`,
            icon: ClipboardList,
                            ...
                            <Link key={kpi.title} href={kpi.href} className="group focus:outline-none">
                                <Card className="h-full hover:border-brand-300 hover:shadow-md transition-all duration-200 group-hover:-translate-y-0.5 border-neutral-200/90">
                                    ...
                                    <div className="mt-3 pt-2.5 border-t border-neutral-100 flex items-center justify-between text-xs text-neutral-500">
                                        ...
                                        <ArrowRight className="w-3.5 h-3.5 text-neutral-400 group-hover:text-brand-600 transition-colors shrink-0 ml-1" />
                                    </div>
                                </Card>
                            </Link>
                        );
