                    ...
                    <div className="mt-8 pt-6 border-t border-neutral-200">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-xs">
                            <div className="p-2.5 rounded border border-neutral-200 bg-neutral-50">
                                <span className="font-semibold text-neutral-800 block">Admin Role</span>
                            ...
                            <div className="p-2.5 rounded border border-neutral-200 bg-neutral-50">
                                <span className="font-semibold text-neutral-800 block">Staff Role</span>
                                <span className="text-neutral-500 block truncate">staff@salahinternational.com</span>
                                <span className="text-neutral-400 block mt-0.5">pass: password</span>
                            </div>
                        </div>
                    </div>
